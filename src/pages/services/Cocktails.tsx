            ...
            <AnimatedSection>
              <div className="prose prose-lg max-w-none">
                <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                  Que ce soit pour un cocktail apéritif, déjeunatoire ou dînatoire, 
                  <strong> Au Bon Goût</strong> sublime vos réceptions avec des créations gastronomiques 
                  raffinées et un service impeccable.
                </p>
                <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                  Nos cocktails sont conçus sur-mesure selon vos envies, votre budget et le nombre de convives. 
                  Du simple apéritif aux formules complètes, nous créons des moments inoubliables.
                </p>
              </div>
            </AnimatedSection>
          </div>
        ...
        <div className="container px-4 md:px-6">
          <AnimatedSection className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                "Cocktail apéritif (1h - 1h30)",
                "Cocktail déjeunatoire (2h - 3h)",
                "Cocktail dînatoire (3h - 4h)",
                "Buffet de pièces salées et sucrées",
                "Service avec personnel qualifié",
                "Vaisselle et mobilier si besoin",
                "Mise en place et décoration",
                "Formules adaptées à tous budgets",
              ].map((feature, idx) => (
                <motion.div
                  key={idx}
